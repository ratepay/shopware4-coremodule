...
class PiRatepayRateCalcData implements PiRatepayRateCalcDataInterface
{
    ...
    {
        return Shopware()->Plugins()->Frontend()->PigmbhRatePay()->Config()->RatePayProfileID;
    }
    ...
    {
        return Shopware()->Plugins()->Frontend()->PigmbhRatePay()->Config()->RatePaySecurityCode;
    }
    ...
    {
        return !Shopware()->Plugins()->Frontend()->PigmbhRatePay()->Config()->RatePaySandbox;
    }
